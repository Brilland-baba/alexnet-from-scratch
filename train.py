...
# ── Augmentation : RandomCrop + ColorJitter = +4-6% accuracy sur CIFAR-10
...
# ── Entraînement d'une variante + sauvegarde du meilleur checkpoint
def run(norm_tag):
    ...
    # OneCycleLR : monte lr rapidement puis descend → escape local minima
